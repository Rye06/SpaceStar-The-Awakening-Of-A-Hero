...
public class TextBox {
  ...
  /** Colors/Styling of the Text and TextBox **/
  ...
  TextBox(int x, int y, int w, int h) {
    ...
    W = w;
    H = h;
  } // textbox constructor with parameters
  ...
  boolean KEYPRESSED(char KEY, int keycode) {
    ...
    if (selected) {
      if (keycode == (int)BACKSPACE) {
        ...
        // checks to see if the key is a letter or a number
  ...
  private void addText(char text) {
    ...
    // checks if the text width is in the boundaries of the textbox
  ...
  private boolean overBox(int x, int y) {
    ...
    /******************************************************
     Tests if the mouse is over the text box
     ******************************************************/
