...
class Boosts {
  ...
  void doubleDamageAppear() {
    ...
    doubleDamageY+=3; // moves the double damage boost down
  ...
  void invincibilityAppear() {
    ...
    invincibilityY+=4; // moves the invincibility boost down
  ...
  void fuelAppear() {
    ...
    fuelY+=4; // moves the fuel boost down
  ...
  void healthAppear() {
    ...
    healthY+=4; // moves the health boost down
